...
Pins should be grouped in whatever way makes layout of the part most readable. In some cases this means grouping pins by function, in others it may mean grouping pins by physical layout. There is no obligation for a symbol to represent the physicality of an associated part or footprint, readability of the schematic is paramount. 
